...
<Helmet>
  ...
  <title>고덕 수자인 하우스디 | 입지환경</title>

  <meta
    name="description"
    content="고덕 수자인 하우스디 입지환경 안내. 평택 고덕국제화계획지구 A-67BL 브랜드 아파트의 생활 인프라, 교통환경, 교육환경, 공원·녹지 환경과 미래가치를 확인하세요."
  />

  <meta
    name="keywords"
    content="고덕 수자인 하우스디 입지환경, 평택 고덕 수자인 하우스디, 고덕국제화계획지구 A-67BL, 평택 고덕 아파트, 고덕국제화계획지구 입지, 고덕 수자인 하우스디 교통"
  />
  ...
  <meta
    property="og:title"
    content="고덕 수자인 하우스디 | 입지환경"
  />

  <meta
    property="og:description"
    content="평택 고덕국제화계획지구 A-67BL 고덕 수자인 하우스디 입지환경. 생활 인프라, 교통환경, 교육환경과 공원·녹지 프리미엄을 확인하세요."
  />
  ...
  <meta
    ...
    content="고덕 수자인 하우스디의 교통, 교육, 생활 인프라와 주거환경을 확인하세요."
  />
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "name": "고덕 수자인 하우스디 - 입지환경",

      "url": "https://www.sujain-modellhouse.co.kr/LocationEnvironment/intro",

      "description":
        "고덕 수자인 하우스디 입지환경 페이지입니다. 평택 고덕국제화계획지구 A-67BL 브랜드 아파트의 생활 인프라, 교통환경, 교육환경, 공원·녹지 환경과 미래가치를 안내합니다.",
...
<p className={styles.screenReaderOnly}>
  고덕 수자인 하우스디 입지환경 페이지입니다.
  평택 고덕국제화계획지구 A-67BL에 조성되는 고덕 수자인 하우스디의 생활 인프라와
  교통환경, 교육환경, 공원·녹지 환경 등 입지 가치를 안내합니다.
</p>
