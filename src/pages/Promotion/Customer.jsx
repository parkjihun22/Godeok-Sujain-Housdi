...
<Helmet>
  ...
  <title>고덕 수자인 하우스디 | 관심고객등록</title>

  <meta
    name="description"
    content="고덕 수자인 하우스디 관심고객등록 안내. 평택 고덕국제화계획지구 A-67BL 브랜드 아파트의 분양 정보, 청약 일정, 모델하우스 소식 및 주요 안내를 가장 먼저 확인하세요."
  />

  <meta
    name="keywords"
    content="고덕 수자인 하우스디 관심고객등록, 평택 고덕 수자인 하우스디, 고덕국제화계획지구 A-67BL, 평택 아파트 분양, 고덕 수자인 하우스디 청약, 고덕 수자인 하우스디 모델하우스"
  />
  ...
  <meta
    property="og:title"
    content="고덕 수자인 하우스디 | 관심고객등록"
  />

  <meta
    property="og:description"
    content="고덕 수자인 하우스디 관심고객 등록 시 분양 일정, 모델하우스 소식, 청약 정보 등 주요 안내를 우선 받아보세요."
  />
  ...
  <meta
    ...
    content="고덕 수자인 하우스디 관심고객 등록으로 분양 일정, 청약 정보, 모델하우스 소식을 확인하세요."
  />
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "name":"고덕 수자인 하우스디 - 관심고객등록",

      "url":"https://www.sujain-modellhouse.co.kr/Promotion/Customer",

      "description":
      "고덕 수자인 하우스디 관심고객등록 페이지입니다. 평택 고덕국제화계획지구 A-67BL 브랜드 아파트의 분양 일정, 청약 정보, 모델하우스 소식 등 주요 안내를 우선 제공합니다.",

      "primaryImageOfPage":{
        "@type":"ImageObject",
        "contentUrl":"https://www.sujain-modellhouse.co.kr/img/og/customer.jpg",
        "width":1200,
        "height":630
      },
      ...
      "breadcrumb":{
        ...
        "itemListElement":[
          ...
          },
          {
            ...
            "position":2,
            "name":"관심고객등록",
            "item":"https://www.sujain-modellhouse.co.kr/Promotion/Customer"
          }
        ]
      }
    })}
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>고덕 수자인 하우스디</h2>
