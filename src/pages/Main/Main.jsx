...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `고덕국제화계획지구 중심 입지`,
    text2: `평택 고덕국제화계획지구 A-67BL<br/>
            미래가치를 기대할 수 있는 프리미엄 입지`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `광역 교통망과 직주근접`,
    text2: `주요 도로망과 광역 교통환경<br/>
            삼성 평택캠퍼스 접근성이 우수한 입지`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `풍부한 생활 인프라`,
    text2: `상업시설 · 교육시설 · 생활 편의시설<br/>
            일상을 더욱 편리하게 만드는 주거 환경`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `쾌적한 자연환경과 미래가치`,
    text2: `공원과 녹지 공간을 가까이 누리는 생활<br/>
            실거주와 미래가치를 함께 갖춘 프리미엄 라이프`,
  ...
  <div className={styles.mainImageTextBox}>
    ...
    <div className={styles.mainImageTitleBox}>
      ...
      <div className={styles.mainImageDesc}>
        평택 고덕국제화계획지구 A-67BL에 들어서는<br/>
        브랜드 프리미엄과 풍부한 생활 인프라를 갖춘 주거 단지<br/>
        삼성 평택캠퍼스와 함께 미래가치를 누리는 프리미엄 라이프
      </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 평택 고덕국제화계획지구 A-67BL 중심 입지 프리미엄<br />
                  - 브랜드 가치와 미래가치를 함께 누리는 프리미엄 아파트<br />
                  - 삼성 평택캠퍼스 배후수요와 직주근접 프리미엄<br />
                  - 교육·상업·생활 인프라를 가까이 누리는 주거 환경<br />
                  - 공원과 녹지 공간이 어우러진 쾌적한 주거 설계
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="고덕 수자인 하우스디브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>고덕 수자인 하우스디</div>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="고덕 수자인 하우스디오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <img
            src={mobileImageMain}
            className={styles.mainImage}
            alt="고덕 수자인 하우스디 아파트 모바일 메인 이미지"
          />
          ...
          <div className={styles.mainImageTextSub1}>
            평택 고덕국제화계획지구의 새로운 주거 가치<br/>
            고덕국제화계획지구 A-67BL 프리미엄<br/>
          ...
          <div className={styles.mainImageTitleBox1}>
            ...
            <div className={styles.mainImageDesc1}>
              평택 고덕국제화계획지구 A-67BL에 들어서는<br/>
              생활 인프라와 브랜드 가치를 갖춘 프리미엄 아파트<br/>
              삼성 평택캠퍼스와 함께 미래가치를 누리는 주거 공간
            </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 고덕 수자인 하우스디에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="고덕 수자인 하우스디모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="고덕 수자인 하우스디브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="고덕 수자인 하우스디오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
