...
<Helmet>
  {/* 필수 메타 */}
  <title>고덕 수자인 하우스디 | 공급안내</title>

  <meta
    name="description"
    content="고덕 수자인 하우스디 공급안내. 평택 고덕국제화계획지구 A-67BL에 공급되는 브랜드 아파트의 공급정보, 주택형 구성, 청약 절차, 제출서류 및 계약 관련 주요 내용을 확인하세요."
  />

  <meta
    name="keywords"
    content="고덕 수자인 하우스디 공급안내, 평택 고덕 수자인 하우스디, 고덕국제화계획지구 A-67BL, 평택 고덕 아파트, 고덕 수자인 하우스디 청약, 고덕 수자인 하우스디 모집공고"
  />
  ...
  <meta
    property="og:title"
    content="고덕 수자인 하우스디 | 공급안내"
  />

  <meta
    property="og:description"
    content="평택 고덕국제화계획지구 A-67BL 고덕 수자인 하우스디 공급정보, 청약 절차, 제출서류 및 계약 관련 내용을 확인하세요."
  />
...
<p className={styles.screenReaderOnly}>
  고덕 수자인 하우스디 공급안내 페이지입니다.
  평택 고덕국제화계획지구 A-67BL에 공급되는 고덕 수자인 하우스디의 주택형 구성,
...
<div className={styles.textBox}>
  ...
  <div>고덕 수자인 하우스디 공급정보를 확인하세요.</div>
</div>

<img
  className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`}
  src={page1}
  alt="고덕 수자인 하우스디 공급정보 및 청약 안내 이미지"
/>
